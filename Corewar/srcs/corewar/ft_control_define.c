...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2018/06/05 16:16:52 by ccorsin           #+#    #+#             */
/*   Updated: 2018/06/05 17:01:29 by clanglai         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
{
	if (IND_SIZE <= 0 || REG_SIZE <= 0 || MAX_PLAYERS <= 0 || MEM_SIZE <= 23
		|| REG_CODE <= 0 || DIR_CODE <= 0 || IND_CODE <= 0
		|| MAX_ARGS_NUMBER <= 0 || MAX_PLAYERS <= 0 || IDX_MOD <= 0
