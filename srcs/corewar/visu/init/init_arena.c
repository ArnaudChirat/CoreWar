...
/*   Updated: 2018/06/13 18:21:29 by lbelda           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static void	init_shader_paths(t_v_arena *a)
{
	...
	a->shader_paths[1] = "srcs/corewar/visu/shaders/player1.frg";
	a->shader_paths[2] = "srcs/corewar/visu/shaders/player.vtx";
	a->shader_paths[3] = "srcs/corewar/visu/shaders/player2.frg";
	a->shader_paths[4] = "srcs/corewar/visu/shaders/player.vtx";
	a->shader_paths[5] = "srcs/corewar/visu/shaders/player3.frg";
	a->shader_paths[6] = "srcs/corewar/visu/shaders/player.vtx";
	a->shader_paths[7] = "srcs/corewar/visu/shaders/player4.frg";
}
...
static void	init_instances_buffers(t_v_arena *a, int i)
{
	...
	glBufferData(GL_ARRAY_BUFFER, MEM_SIZE * sizeof(t_glfloat2),
